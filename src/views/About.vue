...
<template>
  <div id="about">
    <section class="banner flex-center text-center parallax z1 mb-4">
      <div>
    ...
    <section class="description banner text-center">
      <h1>About Webinizer</h1>
      <div class="text-left mt-4">
        A collection of tools to convert native applications, such as these programmed by
        C/C++/Rust, to Web applications which are constructed by HTML/CSS/JavaScript and
        WebAssembly.
      </div>
      <div class="text-left mt-2 mb-4">
        Webinizer consists of two parts; a core engine that analyzes the code and then either fixes
        or highlights issues, and a web frontend to configure projects and display results. For the
        core engine see the
        <a href="https://github.com/intel/webinizer">webinizer</a>
        repo, for the web frontend see the
        <a href="https://github.com/intel/webinizer-webclient">webinizer-webclient</a>
        repo.
      </div>
      <h1>Contributing</h1>
      <div class="text-left mt-4">
        We welcome contributions to Webinizer. You can find more details in
        <a href="https://github.com/intel/webinizer/blob/main/CONTRIBUTING.md">contributing.md</a>.
      </div>
    </section>
  </div>
</template>
...
.parallax:hover svg .cls-1,
.parallax:hover svg .cls-5,
.parallax:hover svg .cls-6 {
  stroke: var(--white);
}
